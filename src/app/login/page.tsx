...
import { Mail, Lock, Eye, EyeOff, GitBranch, AlertCircle } from 'lucide-react'
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-light)', padding: '2rem' }}>
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: '800', color: '#111827', marginBottom: '0.25rem' }}>Welcome back</h1>
          <p style={{ color: '#6b7280', fontSize: '0.9rem' }}>Sign in to manage your family tree</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#6b7280' }}>
          ...
          <Link href="/register" style={{ color: 'var(--primary-color)', fontWeight: '700', textDecoration: 'none' }}>
            Create one free
          </Link>
        </p>
      </div>
