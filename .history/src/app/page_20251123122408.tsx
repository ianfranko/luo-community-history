...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
     {/* Hero Section */}
<section className="hero py-24 text-white bg-cover bg-center">
  <div className="container mx-auto px-6">
    <div className="hero-content text-center max-w-3xl mx-auto">
      ...
      <nav className="mt-10">
        <ul className="flex flex-wrap justify-center gap-6 text-sm uppercase tracking-wider">
      ...
      <section id="voices"
  className="h-[80vh] flex flex-col items-center justify-start overflow-hidden pt-6"
>
  <div className="container py-4 max-w-6xl mx-auto flex flex-col h-full">

    {/* Title */}
    <h2 className="section-title py-4 text-center mb-1">Voice of the People</h2>
    ...
    <div className="flex justify-center max-h-[2vh] mb-4">
  <Image
    src="/luo_03.jpg"
    alt="Community Archive"
    width={1000}
    height={500}
    className="object-cover w-full max-w-2xl h-[80px] shadow"/>
</div>
